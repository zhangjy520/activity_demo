...
public class GroupleaderListener extends SpringBeanAutowiringSupport implements TaskListener{
	...
	public void notify(DelegateTask delegateTask) {
		List<BsUser> users = bsUserService.queryUsersByRoleCode("R0001");
